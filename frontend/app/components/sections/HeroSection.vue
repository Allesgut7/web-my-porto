...
<template>
  <section class="relative overflow-hidden min-h-[85vh]">
    ...
    <div class="floating-particle h-2 w-2 bg-cyan-400/30 top-[60%] left-[10%]" style="--duration: 14s; --delay: 4s; --tx1: 10px; --ty1: -25px; --tx2: -8px; --ty2: -40px; --tx3: 12px; --ty3: -18px; --opacity: 0.3;" />
    <div class="floating-particle h-3.5 w-3.5 bg-blue-300/25 top-[70%] right-[12%]" style="--duration: 11s; --delay: 1s; --tx1: -18px; --ty1: -12px; --tx2: 14px; --ty2: -28px; --tx3: -10px; --ty3: -20px; --opacity: 0.25;" />
      ...
      <div class="app-container grid items-center gap-12 lg:grid-cols-[1.15fr_0.85fr]">
        ...
        <div class="space-y-8">
          ...
          <div class="animate-fade-in-up stagger-children flex flex-wrap gap-2.5">
            <span
              ...
              :key="domain.key"
              class="inline-flex items-center gap-2 rounded-full border border-slate-200/80 dark:border-slate-700/80 bg-white/80 dark:bg-slate-800/80 px-4 py-2 text-sm font-medium text-app-muted dark:text-slate-400 backdrop-blur-sm transition-all duration-300 hover:border-brand-primary hover:text-brand-primary hover:shadow-glow-blue hover:-translate-y-0.5"
            >
          ...
          <div class="animate-fade-in-up delay-200">
            <h1 class="text-5xl font-extrabold leading-[1.08] tracking-tight text-app-text dark:text-slate-50 md:text-7xl lg:text-[5.2rem] font-display">
              Building
          ...
          <!-- Headline from API -->
          <div v-if="profile.headline" class="animate-fade-in-up delay-300">
            <p class="font-mono text-sm font-semibold text-brand-primary tracking-wide">
              {{ profile.headline }}
            </p>
          </div>
          ...
          <p class="animate-fade-in-up delay-500 max-w-2xl text-lg leading-8 text-app-muted dark:text-slate-400 md:text-xl">
            {{ t('heroDescription') }}
          </p>
          ...
          <!-- Meta badges -->
          <div class="animate-fade-in-up delay-700 flex flex-wrap gap-3 text-sm text-app-muted dark:text-slate-400">
        ...
        <div class="space-y-4 animate-slide-in-right delay-300">
          ...
          <div class="app-card overflow-hidden shadow-deep gradient-border">
            <!-- Terminal header -->
            <div class="flex items-center gap-2 border-b border-app-border dark:border-slate-800 bg-slate-50/80 dark:bg-slate-800/80 px-5 py-3 backdrop-blur-sm">
              ...
              <span class="ml-3 font-mono text-xs text-app-muted dark:text-slate-400">SYSTEM_TOPOLOGY v2.0</span>
            </div>

            <div class="relative bg-[#0a0f1a] p-6 overflow-hidden">
              <!-- Background glow -->
              <div class="absolute inset-0 bg-gradient-to-br from-blue-600/15 via-transparent to-cyan-500/8" />
              ...
              >
                ...
                <!-- Orbital rings -->
                <circle cx="200" cy="140" r="75" fill="none" stroke="#1D4ED8" stroke-opacity="0.25" stroke-width="1.5" stroke-dasharray="4 4" class="animate-orbit" style="transform-origin: 200px 140px;" />
                <circle cx="200" cy="140" r="110" fill="none" stroke="#06B6D4" stroke-opacity="0.18" stroke-width="1" stroke-dasharray="6 4" class="animate-orbit-reverse" style="transform-origin: 200px 140px;" />
                <circle cx="200" cy="140" r="140" fill="none" stroke="#06B6D4" stroke-opacity="0.10" stroke-width="0.5" stroke-dasharray="8 6" class="animate-orbit" style="transform-origin: 200px 140px; animation-duration: 32s;" />
                ...
                <line x1="200" y1="140" x2="330" y2="190" stroke="#06B6D4" stroke-opacity="0.4" stroke-width="1.5" filter="url(#glow)" />
                ...
                <line x1="200" y1="140" x2="70" y2="80" stroke="#06B6D4" stroke-opacity="0.4" stroke-width="1.5" filter="url(#glow)" />
                ...
                <circle cx="330" cy="190" r="16" fill="#06B6D4" fill-opacity="0.1" stroke="#06B6D4" stroke-width="1.5" />
                <circle cx="330" cy="190" r="5" fill="#06B6D4" filter="url(#glow)" />
                <text x="330" y="215" text-anchor="middle" fill="#22D3EE" font-size="10" font-family="JetBrains Mono, monospace" font-weight="600">DATA</text>
                ...
                <!-- QA node (top-left) -->
                <circle cx="70" cy="80" r="16" fill="#06B6D4" fill-opacity="0.1" stroke="#06B6D4" stroke-width="1.5" />
                <circle cx="70" cy="80" r="5" fill="#06B6D4" filter="url(#glow)" />
                <text x="70" y="58" text-anchor="middle" fill="#22D3EE" font-size="10" font-family="JetBrains Mono, monospace" font-weight="600">QA</text>
            ...
            <div class="border-t border-app-border dark:border-slate-800 bg-slate-50/80 dark:bg-slate-800/80 px-5 py-3.5 font-mono text-xs">
              <div class="flex items-center gap-2">
                <span class="h-2 w-2 rounded-full bg-emerald-400 animate-pulse" />
                <span class="text-cyan-600 dark:text-cyan-400 font-semibold">GET /api/profile</span>
                <span class="ml-auto text-emerald-600 dark:text-emerald-400 font-medium">200 OK</span>
              </div>
              <div class="mt-2 flex flex-wrap gap-x-4 gap-y-1 text-slate-400 dark:text-slate-500">
                <p><span class="text-slate-500 dark:text-slate-400">domains:</span> EE, IoT, Data, Backend, ML, QA</p>
                <p><span class="text-slate-500 dark:text-slate-400">stack:</span> Go + Nuxt + PostgreSQL</p>
                <p><span class="text-slate-500 dark:text-slate-400">storage:</span> Supabase Storage</p>
              </div>
            </div>
          </div>
